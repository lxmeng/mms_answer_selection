...
template <typename Dtype>
void caffe_cpu_ger(const int M, const int N, const Dtype alpha, 
    const Dtype* x, const Dtype* y, Dtype* A);
...
template <typename Dtype>
void caffe_gpu_ger(const int M, const int N, const Dtype alpha, const Dtype* x, 
    const Dtype* y, Dtype* A);
